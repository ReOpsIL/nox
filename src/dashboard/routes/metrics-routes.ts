...
export function setupMetricsRoutes(router: Router, metricsManager: MetricsManager): void {
   ...
   */
  metricsRouter.get('/system', async (req: Request, res: Response) => {
    try {
   ...
   */
  metricsRouter.get('/system/latest', async (_req: Request, res: Response) => {
    try {
   ...
   */
  metricsRouter.get('/agents/:agentId', async (req: Request, res: Response) => {
    try {
   ...
   */
  metricsRouter.get('/agents/:agentId/latest', async (req: Request, res: Response) => {
    try {
      const agentId = req.params.agentId as string;
   ...
   */
  metricsRouter.get('/agents', async (_req: Request, res: Response) => {
    try {
   ...
   */
  metricsRouter.post('/collect', async (_req: Request, res: Response) => {
    try {
